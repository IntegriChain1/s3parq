...
class Test:
    ...
    def test_index_containing_substring(self):
        ...
        index = parq.index_containing_substring(test_list, '=')
        assert index == 1
    ...
    def test_get_partition_location(self):
        ...
        assert partition_path == 'path/to/data/apple=abcd'
    ...
    def test_generate_partition_sql(self):
        ...
        assert generated_sql == "ALTER TABLE MySchema.MyTable               ADD PARTITION (apple='abcd' ,banana='1234')               LOCATION 's3://MyBucket/path/to/data/apple=abcd';"
